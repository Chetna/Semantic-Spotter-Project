...
- **Generating Embeddings:**  We will be
  using [CohereEmbeddings](https://python.langchain.com/docs/integrations/text_embedding/cohere/) from LangChain
  package. The Embeddings class
  is a class designed for interfacing with text embedding models.
  LangChain provides support for most of the embedding model providers (Cohere) including sentence transformers
...
- Python 3.9+
- langchain 0.3.25
- Please ensure that you add your Cohere API key to the empty text file named "Cohere_API_Key.txt" in order to access
  the Cohere API.
...
- Clone the github repository
  ```shell
  $ git clone https://github.com/Chetna/Semantic-Spotter-Project.git
  ```
